          ...
          <div class="mt-6 space-y-6">
            <div class="relative flex gap-x-3">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Gluten</label>
                <p class="text-gray-500">Céréales contenant du gluten (blé, seigle, orge, avoine, épeautre, kamut ou leurs souches hybridées) et produits à base de ces céréales</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Crustacés</label>
                <p class="text-gray-500">et produits à base de crustacés</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Oeufs</label>
                <p class="text-gray-500">et produits à base d’œufs</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Arachides</label>
                <p class="text-gray-500">et produits à base d'arachides</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Poissons</label>
                <p class="text-gray-500">et produits à base de poissons</p>
              </div>
            </div>
            ...
            <div class="relative flex gap-x-3">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Soja</label>
                <p class="text-gray-500">et produits à base de soja</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="candidates" class="font-medium text-gray-900">Lait</label>
                <p class="text-gray-500">et produits à base de lait (y compris de lactose)</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Fruits à coques</label>
                <p class="text-gray-500">(amandes, noisettes, noix, noix de cajou, pécan, macadamia, du Brésil, du Queensland, pistaches) et produits à base de ces fruits</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Céleri</label>
                <p class="text-gray-500">et produits à base de céleri</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Moutarde</label>
                <p class="text-gray-500">et produits à base de moutarde</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Graines de sésame</label>
                <p class="text-gray-500">et produits à base de graines de sésame</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Anhydride sulfureux et sulfites</label>
                <p class="text-gray-500">en concentration de plus de 10 mg/kg ou 10 mg/l</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Lupin</label>
                <p class="text-gray-500">et produits à base de lupin</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900">Mollusques</label>
                <p class="text-gray-500">et produits à base de mollusques</p>
              </div>
            </div>
            <div class="relative flex gap-x-3">
              <div class="flex h-6 items-center">
              ...
              <div class="text-sm leading-6 grid grid-cols-2 gap-4">
                <label for="offers" class="font-medium text-gray-900">Autres</label>
