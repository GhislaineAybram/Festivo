...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/h3/dist/index.mjs';
import { createClient } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/@supabase/supabase-js/dist/main/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/devalue/index.js';
import destr from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/vue/index.mjs';
import BaseStyle from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/@primeuix/styled/index.mjs';
import { hash } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/ghiso/Documents/RNCP/Festify/node_modules/@unhead/shared/dist/index.mjs';
...
const _7bLFSL0QHl = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/ghiso/Documents/RNCP/Festify";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"Festivo","content":"Organisez vos événements et invitez vos amis facilement avec Festivo. Créez, gérez et partagez vos événements en un clic."}],"link":[{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},{"rel":"manifest","href":"/manifest.json"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"Festivo, where every event comes to life"};
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "supabase": {
      "url": "https://gokpqdvtbbnsmpxuikcj.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdva3BxZHZ0YmJuc21weHVpa2NqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjk3MTcwMDEsImV4cCI6MjA0NTI5MzAwMX0.WeaytIl1t7N4iboD7zc-xWKCH4qx-3gWT1xPhOxIDxE",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/ghiso/Documents/RNCP/Festify/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ghiso\\Documents\\RNCP\\Festify","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ghiso\\Documents\\RNCP\\Festify\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ghiso\\Documents\\RNCP\\Festify\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ghiso\\Documents\\RNCP\\Festify\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\ghiso\\Documents\\RNCP\\Festify\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const styles$2 = [
    ,
    BaseStyle && BaseStyle.getStyleSheet ? BaseStyle.getStyleSheet(undefined, styleProps) : '',AvatarStyle && AvatarStyle.getStyleSheet ? AvatarStyle.getStyleSheet(undefined, styleProps) : ''
].join('');
...
[
    ...
    BaseStyle && BaseStyle.getThemeStyleSheet ? BaseStyle.getThemeStyleSheet(undefined, styleProps) : '',AvatarStyle && AvatarStyle.getThemeStyleSheet ? AvatarStyle.getThemeStyleSheet(undefined, styleProps) : ''
].join('');

const defineNitroPlugin = (def) => def;
const _wieVCfZdrn = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_xJcZ7h = () => Promise.resolve().then(function () { return _id_$b; });
const _lazy_7vQhLq = () => Promise.resolve().then(function () { return avatars$1; });
const _lazy_7nlGBz = () => Promise.resolve().then(function () { return celebration_post$1; });
const _lazy_oYsw4g = () => Promise.resolve().then(function () { return _id_$9; });
const _lazy_ugIAVi = () => Promise.resolve().then(function () { return _id_$7; });
const _lazy_UvPfWX = () => Promise.resolve().then(function () { return _id_$5; });
const _lazy_b8y3Lf = () => Promise.resolve().then(function () { return guest_post$1; });
const _lazy_cYLgSj = () => Promise.resolve().then(function () { return _celebration__get$1; });
const _lazy_QdYIqC = () => Promise.resolve().then(function () { return _celebration__post$1; });
const _lazy_SLZj0r = () => Promise.resolve().then(function () { return _id_$3; });
const _lazy_Y8IreP = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_QFTKBW = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_zsrGfP = () => Promise.resolve().then(function () { return users$1; });
const _lazy_ftMOoz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/avatar/user/:id', handler: _lazy_xJcZ7h, lazy: true, middleware: false, method: undefined },
  { route: '/api/avatars', handler: _lazy_7vQhLq, lazy: true, middleware: false, method: undefined },
  { route: '/api/celebration', handler: _lazy_7nlGBz, lazy: true, middleware: false, method: "post" },
  { route: '/api/celebration/:id', handler: _lazy_oYsw4g, lazy: true, middleware: false, method: undefined },
  { route: '/api/celebrations/author/:id', handler: _lazy_ugIAVi, lazy: true, middleware: false, method: undefined },
  { route: '/api/celebrations/guest/:id', handler: _lazy_UvPfWX, lazy: true, middleware: false, method: undefined },
  { route: '/api/guest', handler: _lazy_b8y3Lf, lazy: true, middleware: false, method: "post" },
  { route: '/api/guest/:user/:celebration', handler: _lazy_cYLgSj, lazy: true, middleware: false, method: "get" },
  { route: '/api/guest/:user/:celebration', handler: _lazy_QdYIqC, lazy: true, middleware: false, method: "post" },
  { route: '/api/guests/celebration/:id', handler: _lazy_SLZj0r, lazy: true, middleware: false, method: undefined },
  { route: '/api/user/:id', handler: _lazy_Y8IreP, lazy: true, middleware: false, method: "delete" },
  { route: '/api/user/:id', handler: _lazy_QFTKBW, lazy: true, middleware: false, method: undefined },
  { route: '/api/users', handler: _lazy_zsrGfP, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ftMOoz, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ftMOoz, lazy: true, middleware: false, method: undefined }
];
...
const updateAvatarByUser = async (id, newAvatar) => {
  const { data, error } = await supabase.from("user").update({ avatar: newAvatar }).eq("user_id", id).select();
  if (error) {
...
const updateIsComingGuest = async (userId, celebrationId, isComing) => {
  const { data, error } = await supabase.from("guest").update({ is_coming: isComing }).eq("user_id", userId).eq("celebration_id", celebrationId).select();
  if (error) {
...
const getIsComingGuest = async (userId, celebrationId) => {
  var _a;
  const { data, error } = await supabase.from("guest").select("is_coming").eq("user_id", userId).eq("celebration_id", celebrationId).single();
  if (error) {
    console.error("Error fetching guest response:", error);
    return null;
  }
  return (_a = data == null ? void 0 : data.is_coming) != null ? _a : null;
};
const getNumberGuestsByCelebration = async (id) => {
  const { count, error } = await supabase.from("guest").select("*", { count: "exact", head: true }).eq("celebration_id", id);
  if (error) {
...
const getGuestsByCelebration = async (id) => {
...
const getUpcomingCelebrationsByAuthor = async (id) => {
  const { data, error } = await supabase.from("celebration").select(`
      *,
      celebration_type:celebration_type(picture)
    `).eq("author", id).gte("date", (/* @__PURE__ */ new Date()).toISOString()).order("date", { ascending: true });
  if (error) {
...
const getPastCelebrationsByAuthor = async (id) => {
  const { data, error } = await supabase.from("celebration").select(`
      *,
      celebration_type:celebration_type(picture)
    `).eq("author", id).lt("date", (/* @__PURE__ */ new Date()).toISOString()).order("date", { ascending: false });
  if (error) {
    console.error("Error fetching celebrations list:", error);
    return [];
  }
...
const getUpcomingCelebrationsByGuest = async (id) => {
  const { data, error } = await supabase.from("celebration").select(`
      *,
      celebration_type:celebration_type(picture),
      guest!inner(user_id,user_id)
    `).eq("guest.user_id", id).gte("date", (/* @__PURE__ */ new Date()).toISOString()).order("date", { ascending: true });
  if (error) {
    console.error("Error fetching celebrations list:", error);
    return [];
  }
...
const getPastCelebrationsByGuest = async (id) => {
  const { data, error } = await supabase.from("celebration").select(`
      *,
      celebration_type:celebration_type(picture),
      guest!inner(user_id,user_id)
    `).eq("guest.user_id", id).lt("date", (/* @__PURE__ */ new Date()).toISOString()).order("date", { ascending: false });
  if (error) {
    console.error("Error fetching celebrations list:", error);
    return [];
  }
...
const newCelebration = async (newCelebrationData) => {
  const { data, error } = await supabase.from("celebration").insert([newCelebrationData]).select("*");
  if (error) {
...
const isExistingGuest = async (user_id, celebration_id) => {
  const { data, error } = await supabase.from("guest").select("*").eq("user_id", user_id).eq("celebration_id", celebration_id).single();
  if (error) {
...
const newGuest = async (newGuestData) => {
  const { data, error } = await supabase.from("guest").insert([newGuestData]).select("*");
  if (error) {
...
const _id_$a = defineEventHandler(async (event) => {
  try {
...
const _id_$b = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _id_$a
});

const avatars = defineEventHandler(async () => {
  try {
...
const avatars$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: avatars
});

const celebration_post = defineEventHandler(async (event) => {
  try {
...
const celebration_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: celebration_post
});
...
const _id_$6 = defineEventHandler(async (event) => {
  try {
    ...
    return {
      past: celebrationsPast != null ? celebrationsPast : [],
      upcoming: celebrationsUpcoming != null ? celebrationsUpcoming : []
    };
  } catch (error) {
    console.error(error);
    return {
...
const guest_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: guest_post
});

const _celebration__get = defineEventHandler(
  async (event) => {
...
const _celebration__get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _celebration__get
});

const _celebration__post = defineEventHandler(async (event) => {
  try {
    const { userId, celebrationId, isComing } = await readBody(event);
    if (!userId || !celebrationId || isComing === void 0) {
      return {
        statusCode: 400,
...
const _celebration__post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _celebration__post
});
...
const getClientManifest = () => import('file://C:/Users/ghiso/Documents/RNCP/Festify/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/ghiso/Documents/RNCP/Festify/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
